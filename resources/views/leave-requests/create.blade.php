    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            @foreach ($quotaCards as $card)
                <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-5 hover:shadow-2xl transition-shadow duration-300">
                    <div class="flex items-center justify-between mb-3">
                        <div class="p-2 rounded-lg {{ $card['remaining'] > 0 ? 'bg-blue-50' : 'bg-red-50' }}">
                            <svg class="w-5 h-5 {{ $card['remaining'] > 0 ? 'text-blue-600' : 'text-red-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                            </svg>
                        </div>
                        <span class="text-xs font-medium px-2 py-1 rounded-full {{ $card['remaining'] > 0 ? 'bg-green-50 text-green-700' : 'bg-red-50 text-red-700' }}">
                            {{ $card['remaining'] > 0 ? 'Tersedia' : 'Habis' }}
                        </span>
                    </div>
                    <p class="text-sm text-gray-500 mb-1">{{ $card['label'] }}</p>
                    <p class="text-3xl font-bold {{ $card['remaining'] > 0 ? 'text-gray-800' : 'text-red-600' }} mb-2">
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-blue-50 to-teal-50 px-6 py-4 border-b border-gray-200">
                <div class="flex items-center">
                    ...
                    <div>
                        <h2 class="text-lg font-semibold text-gray-800">Informasi Cuti</h2>
            ...
            <form method="POST"
                    ...
                    <div class="relative">
                        ...
                        <select name="leave_type" required
                                class="block w-full pl-10 pr-10 py-3 rounded-lg border border-gray-300 
                                       ...
                                       focus:bg-white transition-colors text-gray-800 appearance-none">
                            ...
                            @foreach ([
                                ...
                                <option value="{{ $val }}" {{ old('leave_type') === $val ? 'selected' : '' }} class="text-gray-800">
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="bg-blue-50 border border-blue-100 rounded-xl p-4">
                    <div class="flex items-center">
                        ...
                        <div class="text-sm text-blue-800">
                            <p class="font-medium">Durasi Cuti: <span id="duration-display" class="font-bold">0 hari</span></p>
                            <p class="text-blue-700 mt-1" id="date-range-display">Pilih tanggal mulai dan selesai untuk menghitung durasi</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="relative">
                        <textarea name="reason" id="reason" rows="5" required
                                  class="block w-full px-4 py-3 rounded-lg border border-gray-300 
                                         bg-gray-50 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 
                                         focus:bg-white transition-colors placeholder-gray-500 text-gray-800"
                ...
                <div class="space-y-2">
                    ...
                    <div class="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-blue-400 hover:bg-blue-50 transition-colors duration-200">
                        <div class="flex flex-col items-center">
                            ...
                            <label for="attachment" 
                                   class="cursor-pointer inline-flex items-center px-4 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors">
        ...
        <!-- Help Section -->
        <div class="mt-8 bg-gradient-to-r from-blue-50 to-teal-50 border border-blue-100 rounded-2xl p-6">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function resetForm() {
            ...
            resetBtn.classList.remove('border-gray-300', 'text-gray-700', 'hover:bg-gray-50');
            resetBtn.classList.add('border-green-500', 'text-green-700', 'bg-green-50');
            
            // Revert after 2 seconds
            setTimeout(() => {
                resetBtn.innerHTML = originalHtml;
                resetBtn.classList.remove('border-green-500', 'text-green-700', 'bg-green-50');
                resetBtn.classList.add('border-gray-300', 'text-gray-700', 'hover:bg-gray-50');
            }, 2000);
